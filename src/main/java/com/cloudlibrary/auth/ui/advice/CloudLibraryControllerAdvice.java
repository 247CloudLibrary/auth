...
public class CloudLibraryControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(CloudLibraryException.class)
    public ResponseEntity<?> opMessageException(CloudLibraryException ex) {
